...
TVSchedulePg.midKeyDown = function () {
    ...
    switch (keyCode) {
        ...
        case tvKey.KEY_PANEL_ENTER:
            ...
            productNumber = 0;
            jQuery('#product>#product_header>#reserve_Category').show();//예약 버튼을 다시 표시한다..
            //해당 중분류의 상품들을 불러온다!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            //ajax요청
...
TVSchedulePg.listKeyDown = function () {
    ...
    switch (keyCode) {
        ...
        case tvKey.KEY_LEFT:
            ...
            if (productListIndex % 4 == 0 || productIndex == 0) {//상품 리스트의 제일 왼쪽에 있을 때
        ...
        case tvKey.KEY_DOWN:
            ...
            if (productNumber != 0) {//상품이 하나라도 있을 때만
